...
const badgeVariants = cva(
  "inline-flex items-center rounded-sm border px-2 py-0.5 text-[10px] font-bold uppercase tracking-widest transition-colors focus:outline-none focus:ring-2 focus:ring-[hsl(var(--ring))] focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        neutral:
          "border-transparent bg-[hsl(var(--sn-neutral))] text-[hsl(var(--sn-neutral-foreground))]",
      },
    },
    defaultVariants: {
      variant: "default",
