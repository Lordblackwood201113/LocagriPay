  ...
  "relative w-full rounded-sm border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-[hsl(var(--warning))]/50 bg-[hsl(var(--warning))]/10 text-[hsl(var(--warning-foreground))]",
        info: "border-[hsl(var(--info))]/50 bg-[hsl(var(--info))]/10 text-[hsl(var(--info-foreground))]",
      },
    },
    defaultVariants: {
      variant: "default",
